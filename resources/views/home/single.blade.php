	...
	<div class="col-sm-3 col-md-2 sidebar">
		...
		<div class="drop-navigation drop-navigation">
			<ul class="nav nav-sidebar">
				<li class="active"><a href="/" class="home-icon"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>主页</a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			<div class="show-top-grids">
				<div class="col-sm-8 single-left" style="width: 100%">
					<div class="song">
						<div class="song-info">
							<h3>{{$result->introductiontitle}}</h3>
					</div>
						<div class="video-grid">
							<video width="100%" controls src="{{$result->video}}"></video>
						</div>
					</div>
								...
								<ul id="myList">
									...
									<li>
										...
										<div class="load-grids">
											...
											<div class="load-grid">
												<a href="movies.blade.php">Entertainment</a>
											</div>
											<div class="clearfix"> </div>
										</div>
									</li>
						...
						<div class="all-comments-info">
							...
							<div class="box">
								<form method="post" action="" id="queryForm">
									...
									<input type="text" placeholder="手机" name="mobile" required=" ">
									<input type="text" style="display: none" name="id" id="formid">
									<textarea placeholder="评论信息" name="message" required=" "></textarea>
							...
							@foreach($homesingle as $val)
								<div class="media">
									...
									<div class="media-body">
										<p>{{$val->message}}</p>
										<span>发表人 :<a href="#"> {{$val->name}} </a></span>
									</div>
								</div>
							@endforeach
						</div>
