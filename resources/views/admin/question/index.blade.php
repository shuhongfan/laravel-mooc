...
<div class="page-container">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
        <span class="l">
            ...
            <a href="javascript:;" onclick="admin_add('添加试题','/admin/manager/add','800','500')" class="btn btn-primary radius">
                <i class="Hui-iconfont">&#xe600;</i>
                添加试题
            </a>
    ...
    <table class="table table-border table-bordered table-bg">
        ...
        @foreach($data as $val)
            <tr class="text-c"  >
                ...
                <td>{{$val->score}}</td>
                <td>
                    <a href="javascript:;" onclick="showOptions('{{$val->options}}')">查看选项</a>
                </td>
                <td>{{$val->answer}}</td>
                ...
                <td class="td-manage">
                    ...
                    @endif
                    <a title="编辑" href="javascript:;" onclick="admin_edit('试题编辑','/admin/manager/update/{{$val->id}}','{{$val->id}}','800','550')" class="ml-5" style="text-decoration:none">
                        <i class="Hui-iconfont">&#xe6df;</i>
                    </a>
