...
<div class="loginWraper">
    <div id="loginform" class="loginBox">
        <form class="form form-horizontal" action="/admin/public/check" method="post" id="login">
            <div class="row cl">
...
{{--             图标：http://www.h-ui.net/Hui-3.7-Hui-iconfont.shtml--}}
                <label class="form-label col-xs-3"><i class="Hui-iconfont">&#xe6cb</i></label>
                <div class="formControls col-xs-8 ">
...
{{--                  验证码  {{captcha_src()}}--}}
                    <img src={{captcha_src()}}> <a id="kanbuq" href="javascript:;">换一张</a>
                </div>
            </div>
            {{csrf_field()}}
            <div class="row cl">
