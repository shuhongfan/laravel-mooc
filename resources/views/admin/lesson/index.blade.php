...
<div class="page-container">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
        <span class="l">
            ...
            <a href="javascript:;" onclick="admin_add('添加点播','/admin/manager/add','800','500')" class="btn btn-primary radius">
                <i class="Hui-iconfont">&#xe600;</i>
                添加点播
            </a>
        </span>
    ...
    <table class="table table-border table-bordered table-bg">
        ...
        @foreach($data as $val)
            <tr class="text-c"  >
                ...
                <td>
                    <a href="javascript:;" onclick="video_play('{{$val->lesson_name}}','/admin/lesson/play?id={{$val->id}}','800','500')" class="btn btn-primary radius">
                        <i class="Hui-iconfont">&#xe6e6;</i>
                        播放
                    </a>
                </td>
                ...
                <td class="td-manage">
                    ...
                    @endif
                    <a title="编辑" href="javascript:;" onclick="admin_edit('点播编辑','/admin/manager/update/{{$val->id}}','{{$val->id}}','800','550')" class="ml-5" style="text-decoration:none">
                        <i class="Hui-iconfont">&#xe6df;</i>
                    </a>
